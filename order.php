        ...
        <div class="container">
            ...
            <form action="" method="POST" class="order">
                ...
                <fieldset>
                    ...
                    <div class="order-label">Delivery Mode</div>
                    <input type="text" name="cash-on-delivery" placeholder="Cash On Delivery" class="input-responsive" required>
            ...
            <?php 
                ...
                if(isset($_POST['submit']))
                {
                    ...
                    $delivery_mode = $_POST['cash-on-delivery'];
